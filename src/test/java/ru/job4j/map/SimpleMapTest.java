...
class SimpleMapTest {
    ...
    @Test
    void whenCheckPutNullAndRemoveZero() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(null, "0000")).isTrue();
    ...
    @Test
    void whenCheckPutZeroAndRemoveNull() {
        SimpleMap<Integer, String> nmap = new SimpleMap<>();
        assertThat(nmap.put(0, "0000")).isTrue();
        assertThat(nmap.remove(null)).isFalse();
    }
    ...
    @Test
    void whenConcurrentIteratorPutFalse() {
        map.put(41, "41");
        Iterator<Integer> it = map.iterator();
        map.put(41, "41");
        assertThat(it.hasNext()).isTrue();
    ...
    @Test
    void whenConcurrentIteratorRemoveFalse() {
        Iterator<Integer> it = map.iterator();
        map.remove(41);
        assertThat(it.hasNext()).isTrue();
    }
